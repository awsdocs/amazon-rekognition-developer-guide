...
+ [Detecting and Analyzing Faces](faces.md)
   ...
   + [Detecting Faces in a Stored Video](faces-video.md)
      + [Detecting Faces in a Stored Video (AWS SDK for Java)](faces-sqs-video.md)
+ [Searching Faces in a Collection](collections.md)
   ...
   + [Searching for Faces with Amazon Rekognition Video](collections-search-person.md)
      + [Searching Stored Videos for Faces (AWS SDK for Java)](procedure-person-search-videos.md)
