...
+ [Code examples for Amazon Rekognition](service_code_examples.md)
   + [Cross-service examples for Amazon Rekognition](service_code_examples_cross-service.md)
   ...
   + [Usage examples for Amazon Rekognition](service_code_examples_usage.md)
   ...
   + [API examples for Amazon Rekognition](service_code_examples_api.md)
