...
+ [My stream processor isn't returning the expected results](#w11aac16c13c33c15)
...
### Reason 1: Your stream processor isn't configured correctly<a name="w11aac16c13c33c11b5"></a>
...
### Reason 2: Your stream processor isn't in the RUNNING state<a name="w11aac16c13c33c11b7"></a>
...
### Error: "Access denied to Role"<a name="w11aac16c13c33c13b9"></a>
...
### Error: "Access denied to Kinesis Video *or* Access denied to Kinesis Data"<a name="w11aac16c13c33c13c11"></a>
...
### Error: "Stream *input\-video\-stream\-name* doesn't exist"<a name="w11aac16c13c33c13c13"></a>
...
### Error: "Collection not found"<a name="w11aac16c13c33c13c15"></a>
...
### Error: "Stream *output\-kinesis\-data\-stream\-name* under account *account\-id* not found"<a name="w11aac16c13c33c13c17"></a>
...
## My stream processor isn't returning the expected results<a name="w11aac16c13c33c15"></a>
